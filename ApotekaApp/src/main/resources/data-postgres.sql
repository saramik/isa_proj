...
-- insert into public.korisnici (id,email, lozinka, ime, prezime, adresa,grad, drzava, broj, type, pretplacen, enabled, penali, token_id, tipstrucnoglica) values (2,'anaanic@gmail.com','$2y$10$PlcypQuCmM65W7MikuEIW.vBAMLar2o9UQroEu/fpCN/r06BltbOO','Ana', 'Anic','Adresa 2','Novi Sad', 'Srbija','0600000001','S' ,'false','true', 0, NULL, 1);
--
...
--
-- INSERT INTO public.radnje (id, datum, type, izvrsen, definisan, termin_id, strlice_id, pacijent_id, tippregleda_id) VALUES (1, '2021-6-25', 'P', true, false, 1, 2, 1, 1);
--
-- INSERT INTO public.dijagnoze (id, tip) VALUES (1, 0);
--
-- INSERT INTO public.erecept (id, datumizdavanja, status, pacijent_id) VALUES (1, '2021-6-25', 0, 1);
--
